...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glRotatef(tierra - 4, 0.0, -1.0, 0.0);
	...
	glPushMatrix();
		...
		glRotatef(jupiter - 7, 0.0, -1.0, 0.0);
	...
	glPushMatrix();
		glColor3f(1.0, 0.0, 0.0);
		glRotatef(saturno - 4, 0.0, 1.0, 0.0);
	...
	glRotatef(neptuno - 0.5, 0.0, 1.0, 0.0);
